import { ActivityIndicator, Text, View, StyleSheet, Image, Button, SafeAreaView } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      <View>
        <Image source={require('../Image/appLogo.png')}
          style={{ width: '85%', height: '30%', margin: 30, marginLeft: '8%', resizeMode: 'cover' }} />
        <Text style={{ paddingBottom: '5%', fontStyle: 'italic', textAlign: 'center', fontSize: 18, fontWeight: '300', color: '#000', fontFamily: 'Roboto' }}>
        ...
        >
          ...
          }} style={styles.buttonTextStyle}>Get Started</Text>
